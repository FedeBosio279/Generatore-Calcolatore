...
do
{
    try
    {
        ...
        {
            throw new FormatException("Inserimento non valido. Rispondi 'Si' o 'No'.");
        }
    }
    catch (FormatException)
    {
        Console.WriteLine("Errore: Inserisci si o no");
        return;
    }
...
else if (scelta == 5)
{
    ...
    Console.WriteLine(
        "Il numero verrà nascosto, e il tuo compito sarà indovinare dietro quale valore si trova!"
    );
